...
@Data
@TableName("SYS_CLASSIFICATION_URL")
public class SysClassificationUrlEntity implements Serializable {


    @Serial
    private static final long serialVersionUID = 6629225043442621011L;
